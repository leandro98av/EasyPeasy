...
http.createServer((req, res) => {
	...
	switch (req.url) {
		// Home
		case '/':
            res.write( '​Bienvenidos a DH Movies el mejor sitio para encontrar las mejorespelículas, incluso mucho mejor que Netflix, Cuevana y PopCorn​.')
			res.write('\n\n')
		...
		case '/mas-votadas':
			...
			res.write('\n\n')
			res.write('Hay ' + mayorSiete.length +' peliculas.')
			res.write('\n')
			res.write('El rating promedio es de ' + promedioRating.toFixed(2)+'.\n\n')
			res.end('Más Votadas');
			break;
		case '/sucursales':
			res.write('Nuestras Salas.\n\n\nTenemos '+ theaters.length+ ' salas\n\n')
		...
		case '/preguntas-frecuentes':
			res.write('Preguntas frecuentes.\n\nTenemos '+faqs.length+' preguntas frecuentes: \n\n')
			faqs.forEach((faq)=>{
